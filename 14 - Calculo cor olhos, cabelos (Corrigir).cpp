...
int main() {
	...
	int i, pessoas, idade, soma_pessoas=0, soma_ruivo=0, soma_idade_pessoas=0, soma_olho=0;
	float peso, altura, soma_idade=0, soma_olho_f=0, media_idade, porcent_olho;
